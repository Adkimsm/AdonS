<template>
	...
	>
		<section id="laupad" class="animate__animated" v-if="laupadShow">
			<hr />
			<div class="icons">
				<div class="icon_bottom">
					<h2>LauPad</h2>
					<div class="icons">
						<img id="shutdown_btn" src="../assets/images/shutdown.png" />
						<img
							id="showLockScrBtn"
							src="../assets/images/keyhole-shield.png"
						/>
						<img id="popSettingsBtn" src="" />
					</div>
				</div>
				<div class="icon_top">
					<img id="terminalButton" src="../assets/images/console_48px.png" />
					<img id="markdownButton" src="../assets/images/markdown_48px.png" />
					<svg
					...
					<img id="pluginButton" src="../assets/images/plugin_48px.png" />
					<img
						id="storeButton"
						src="../assets/images/ChromeWebStore_48px.svg"
						width="48"
						height="48"
					/>
				</div>
	...
	<div a @click="laupadShow = !laupadShow">
		<img toggleLaupadBtn />
	</div>
</template>
...
.darkMode section {
	background-color: rgb(24, 24, 24, 0.93);
	color: #fff;
}
...
section .icon_bottom h2 {
	position: absolute;
	left: 35px;
	top: 20px;
}

section .icon_bottom .icons {
	float: right;
}
...
div[a] {
	...
	backdrop-filter: blur(15px);
	transition: all 0.7s cubic-bezier(0.19, 0.3, 0.3, 0.19);
}
