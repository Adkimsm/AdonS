<template>
	<header id="dropSelectToMoveWindow" style="-webkit-app-region: drag">
		Easier
	</header>
	<div class="dropdown">
		<div class="item">
		...
		<div class="item">
			...
			<div class="dropdown-content">
				<a id="dropdownHeaderInstallPluginsBtn">
					Install Plugin From JSON File...
				</a>
				<a id="dropdownHeaderUninstallAllPluginsBtn">
