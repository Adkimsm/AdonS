...
!(function (t, e) {
  ...
  function Pt(t, e) {
    if (!(t instanceof MouseEvent && 2 === t.button)) {
      var n =
        ...
        d =
          'translate3d(' + (a / 2 - u) + 'px,' + (r / 2 - c) + 'px, 0) scale(1)'
      L(
  ...
  L(function () {
    yt.on('input focus blur', '.mdui-textfield-input', { useCapture: !0 }, qt),
      yt.on(
        'click',
  ...
  ;(ue.prototype.triggerEvent = function (t) {
    ...
    (ue.prototype.readjust = function () {
      if (de) {
        ...
        t.height(''), n.height('')
        var o = t.height()
        t.css({ top: (bt.height() - o) / 2 + 'px', height: o + 'px' }),
    ...
    (ue.prototype.transitionEnd = function () {
      this.$element.hasClass('mdui-dialog-open')
        ...
        : ((this.state = 'closed'),
          ...
          bt.off('resize', L.throttle(this.readjust, 100)),
    ...
    (ue.prototype.doOpen = function () {
      ...
      if (
        ...
        this.$element.show(),
        this.readjust(),
        bt.on('resize', L.throttle(this.readjust, 100)),
        (this.state = 'opening'),
        this.triggerEvent('open'),
        ...
        ;-1 < e.indexOf('mdui-dialog') &&
          ...
          (window.location.hash = e
            ...
            : 'mdui-dialog'),
          bt.on('hashchange', this.hashchangeEvent)
      }
    }),
        ...
        setTimeout(function () {
          e.isOpen() &&
            ...
            e.options.history &&
              ...
              bt.off('hashchange', e.hashchangeEvent)),
            setTimeout(function () {
              ae(he)
            }, 100))
        })
  ...
  ;(Ce.prototype.isDisabled = function (t) {
    ...
    (Ce.prototype.setPosition = function () {
      ...
      switch (
        ('auto' === r &&
          (r =
            n.top + n.height + i + s + 2 < bt.height()
              ? 'bottom'
              : i + s + 2 < n.top
              ? 'top'
              : i + o + 2 < n.left
              ? 'left'
              : n.width + i + o + 2 < bt.width() - n.left
              ? 'right'
              : 'bottom'),
        r)
      ) {
            ...
            this.$element.transitionEnd(function () {
              'opening' === e.state &&
                ...
                e.options.closeOnOutsideClick &&
                  yt.on(jt, e.closeOnOutsideClick),
                e.options.timeout &&
    ...
    (Oe.prototype.close = function () {
      ...
      'closing' !== this.state &&
        ...
        this.options.closeOnOutsideClick &&
          yt.off(jt, this.closeOnOutsideClick),
        (this.state = 'closing'),
