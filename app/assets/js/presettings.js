...
document.addEventListener("DOMContentLoaded", () => {
    document.querySelector('#nextWelcome').onclick = () => {
        setTimeout(() => {
            document.querySelector("#welcomeContent").style.animation = "FadeOut .2s linear";
            document.querySelector("#settingsContent").style.animation = "FadeIn .2s linear";
            setTimeout(() => {
    ...
    document.querySelector('#nextSettings').onclick = () => {
        ...
        setTimeout(() => {
            document.querySelector("#settingsContent").style.animation = "FadeOut .2s linear";
